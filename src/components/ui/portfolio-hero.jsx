...
export default function PortfolioHero({ theme, setTheme }) {
    ...
    <>
      ...
      >
        ...
        <main className="relative min-h-screen flex flex-col pt-20">
          ...
          <div className="absolute bottom-16 sm:bottom-20 md:bottom-24 lg:bottom-32 xl:bottom-36 left-1/2 -translate-x-1/2 w-full px-6 pointer-events-none">
